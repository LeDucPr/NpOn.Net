...
namespace AccountServiceObject.EventObjects;

[ProtoContract]
public class AccountSaveLoginEvent : BaseAccountRabbitMqEvent
{
...
{
    public static AccountLoginInfoObject ToObject(this AccountSaveLoginEvent @event)
    {
        return new AccountLoginInfoObject()
        {
            Id = @event.Id,
