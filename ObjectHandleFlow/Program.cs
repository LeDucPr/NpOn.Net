// using Enums;
// using ObjectHandleFlow.AlgObjs.CtrlObjs;
// using ObjectHandleFlow.AlgObjs.CtrlObjs.Connections;
// using ObjectHandleFlow.AlgObjs.RaisingRouters;
// using ObjectHandleFlow.AlgObjs.SqlQueries;
//
// namespace ObjectHandleFlow;
//
// class Program
// {
...
//         {
//             BaseQueryCreatorWithKey queryCreator = new BaseQueryCreatorWithKey(ctrl, ctrlInfo!.DatabaseType);
